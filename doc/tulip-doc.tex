...
{\large \bf Part 4, optional:}
The static version \verb+tulip_static+ can be copied to remote
...
The shared library version requires adding the \verb+libutils+ library
to the library path, \eg specifying the \verb+\$LD...+ environment
