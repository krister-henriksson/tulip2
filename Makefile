...
pkgdatadir = $(datadir)/tulip
pkgincludedir = $(includedir)/tulip
pkglibdir = $(libdir)/tulip
pkglibexecdir = $(libexecdir)/tulip
...
OBJEXT = o
PACKAGE = tulip
PACKAGE_BUGREPORT = krister.henriksson@helsinki.fi
PACKAGE_NAME = tulip
PACKAGE_STRING = tulip 2
PACKAGE_TARNAME = tulip
PACKAGE_URL = 
PACKAGE_VERSION = 2
PATH_SEPARATOR = :
SET_MAKE = 
